...
public class LoginDialog extends javax.swing.JDialog {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        if (listUser.containsKey(jTextField1.getText())) {
            if (DigestUtils.md5Hex(jTextField2.getText()).equals(listUser.get(jTextField1.getText()))) {
                JOptionPane.showMessageDialog(this, "User exists", "Information", JOptionPane.INFORMATION_MESSAGE);
            } else {
